...
describe('ActionControl', function() {
    ...
    it('it should create its own instance of event stream if no intance in passed in constructor', function(done) {
    ...
    it('it should use instance of event stream passed in the constructor', function(done) {
    ...
    //testing action registering and taking action
    it('it should throw an error when registering action with actionName not of type string', function(done) {
        throws = function() {
    ...
    it('it should throw an error when no handler is passed, while registering an action', function(done) {
    ...
    it('it should throw an error when handler is not of type function, while registering an action', function(done) {
    ...
    it('it should throw an error when handler is already set for the action', function(done) {
    ...
    it('it should throw an error when trying to un-register from an action not of type string', function(done) {
        throws = function() {
    ...
    it('it should throw an error when no handler is passed while un-registering to an anction', function(done) {
    ...
    it('it should throw an error when trying to un-register with handler not of type function', function(done) {
    ...
    it('it should throw an error when taking action name not of type string', function(done) {
    ...
    it('it should throw an error when no handler found for the action', function(done) {
    ...
    it('it should successfully call any handler associated with the action', function(done) {
    ...
    it('it should successfully call handler associated with the action, with appropriate parameters', function(done) {
    ...
    it('it should return a promise, when handler returns a promise', function(done) {
    ...
    it('it should return a promise, when handler returns a value', function(done) {
    ...
    it('it should throw an error when trying to unsubscribe all handlers from an event not of type string', function(done) {
        throws = function() {
